...
pub use errors::{NoError, GeneralError, GeneralErrorKind, Unrepresentable, NegOverflow,
                 PosOverflow, FloatError, RangeError, RangeErrorKind, Saturate, UnwrapOk,
...
///
pub mod prelude {
    pub use super::{ApproxFrom, ApproxInto, ValueFrom, ValueInto, GeneralError, GeneralErrorKind,
                    Saturate, UnwrapOk, UnwrapOrInf, UnwrapOrInvalid, UnwrapOrSaturate, ConvUtil,
                    ConvAsUtil, RoundToNearest, RoundToZero, Wrapping};
}
...
impl<Dst, Src, Scheme> ApproxInto<Dst, Scheme> for Src
    where Dst: ApproxFrom<Src, Scheme>,
          Scheme: ApproxScheme
{
    type Err = Dst::Err;
    fn approx_into(self) -> Result<Dst, Self::Err> {
